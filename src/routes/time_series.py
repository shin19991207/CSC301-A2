        ...
        for date in date_range:
            ...
            for location in locations:
                ...
                for type in types:
                    ...
                    if type.capitalize() == "Confirmed" or type.capitalize() == "Active":
                    ...
                    if type.capitalize() == "Deaths" or type.capitalize() == "Active":
                    ...
                    if type.capitalize() == "Recovered" or type.capitalize() == "Active":
                        recovered_query = "SELECT sum(\"{0}\") FROM Recovered WHERE ".format(date) + \
                                          location_str + " GROUP BY region, state;"
